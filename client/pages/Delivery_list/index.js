...
export default function index() {
  ...
  const [refreshButtonStyle, setRefreshButtonStyle] = useState('py-2.5 pl-4 group pr-3.5 text-sm refresh-button rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 flex gap-2 items-center')
  ...
  const handleClickRefresh = async () => {
    function callback(flag) {
      flag ? Router.reload() : setRefreshButtonStyle('py-2.5 pl-4 group pr-3.5 text-sm refresh-button-disable rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 flex gap-2 items-center')
    ...
    <div className='wrapper'>
      ...
      <main className='main'>
        <div className='overflow-hidden'>
          ...
          <button type='button' onClick={handleClickRefresh} className={refreshButtonStyle}>
            Обновить
